...
import { Logger } from '../../../builder/gen-dockerfile/contents/logger';
import { Reader, Writer, Locator, FsView } from '../../../builder/gen-dockerfile/contents/fsview';
import { generateConfigs } from '../../../builder/gen-dockerfile/contents/main';
...
describe('Successful file generation', () => {
  ...
  var logger: Logger;
  before(() => {
    dataView = new FsView(path.join(__dirname, '../../../builder/gen-dockerfile/contents/data/'));
    logger = {
